    ...
    <div class="originalRest">
        ...
        <div class="originalRest__One">
            ...
            <div class="originalRest__box">
                <!-- PICTURE RESTAURANT -->
                <div class="originalRest__picture" style="background-image:url(<?php echo get_template_directory_uri(); ?>/assets/images/resto1.jpg)" alt="restaurant">
                </div>
            </div>
            <div class="originalRest_box">
